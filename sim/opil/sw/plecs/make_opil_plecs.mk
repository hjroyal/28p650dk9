...
ifeq ($(OS),Windows_NT)
	...
	DIR_GUARD := mkdir -p ${BUILD_DIR_WIN}
	SOCK_LIB  := ws2_32
	EXT_LIB   := .dll
	COMM_DIR  := win
else
...
$(PLAT): ${OPIL}/sw/plecs/opil_plecs.c
	${DIR_GUARD}
	gcc -fPIC -O2 $(CFLAGS) -c ${OPIL}/comm/$(COMM_DIR)/hostCommSock.c -I${OPIL}/comm/ -I${OPIL}/ -o ${BUILD_DIR}/hostCommSock.o -DHOST_COMM_SOCK_SERVER_IP=\"${HOST_COMM_SOCK_SERVER_IP}\" -DHOST_COMM_SOCK_SERVER_PORT=${HOST_COMM_SOCK_SERVER_PORT}
	gcc -fPIC -O2 $(CFLAGS) -c ${OPIL}/simif/simif.c -I${STYPES_DIR} -I${OPIL}/ -o ${BUILD_DIR}/simif.o
	gcc -fPIC -O2 $(CFLAGS) -c ${OPIL}/opilhost.c -o ${BUILD_DIR}/opilhost.o
	gcc -fPIC -O2 $(CFLAGS) -c ${OPIL}/sw/plecs/opil_plecs.c -I${STYPES_DIR} -I${OPIL}/ -o ${BUILD_DIR}/opil_plecs.o
ifeq ($(PLAT),win)
