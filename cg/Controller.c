 ...
 *                          TI28P65x 1.10.4
 * Generated on           : 8 Feb 2026 22:44:51
 */
...
static size_t Controller_D_size_t[1];
...
const char * const Controller_checksum =
   "45d0394c3f061d63a17dc6fa5697ef9817cc12f6";
/* Target declarations */
...
void Controller_initialize(void)
{
   ...
   Controller_D_size_t[0] = 0;
   memset(&Controller_X.Delay2[0], 0, 3*sizeof(Controller_X.Delay2[0]));
}
...
void Controller_step(int task_id)
{
   ...
   case 1:                                                                                                                               /* Task "Blink task" */
   {
      ...
      Controller_B.Delay2 =
         *(&Controller_X.Delay2[0]+0+Controller_D_size_t[0]);
      ...
      *(&Controller_X.Delay2[0]+0+
        Controller_D_size_t[0]) = Controller_B.LogicalOperator2;
      Controller_D_size_t[0] += 1;
      if (Controller_D_size_t[0] > 2)
      {
         Controller_D_size_t[0] = 0;
      }
      break;
